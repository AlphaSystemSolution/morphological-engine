...
public class ConjugationMemberTest extends CommonTest {
    ...
    public void runConjugations() {
        ...
        runConjugations(FORM_IV_TEMPLATE, SEEN, LAM, MEEM, null);
    }
    ...
    private void runConjugations(NamedTemplate namedTemplate, ArabicLetterType firstRadical,
        ...
        // Verbal noun
        leftBuilder = factory.getTriLiteralVerbalNounBuilder(ruleProcessor, namedTemplate, false,
                firstRadical, secondRadical, thirdRadical, verbalNoun);
        ...
        rightBuilder = namedTemplate.equals(FORM_IV_TEMPLATE) ?
                factory.getTriLiteralImperativeFormIVBuilder(ruleProcessor, namedTemplate, false, firstRadical, secondRadical, thirdRadical) :
                factory.getTriLiteralImperativeBuilder(ruleProcessor, namedTemplate, false, firstRadical, secondRadical, thirdRadical);
