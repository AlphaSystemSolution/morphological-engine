 ...
 * @author sali
 */
//@Guice(modules = {CloseableModule.class, Jsr250Module.class, SarfEngineModule.class})
public class GuiceTest extends CommonTest {
    ...
    @Test
    public void test() {
        final Injector injector = GuiceSupport.getInstance().getInjector();

        ruleProcessorFactory = injector.getInstance(RuleProcessorFactory.class);
